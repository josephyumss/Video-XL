...
from videoxl.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN



def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="cuda:0", attn_implementation="flash_attention_2", customized_config=None, overwrite_config=None, **kwargs):
    ...
    if "llava" in model_name.lower()  or "videoxl" in model_name.lower() or is_multimodal:
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                from videoxl.model.language_model.llava_mixtral import LlavaMixtralConfig
                ...
                from videoxl.model.language_model.llava_mistral import LlavaMistralConfig
                ...
                from videoxl.model.language_model.llava_gemma import LlavaGemmaConfig
                ...
                from videoxl.model.language_model.llava_llama import LlavaConfig
    ...
    if "llava" in model_name.lower() or "videoxl" in model_name.lower() or is_multimodal:
        ...
        model.resize_token_embeddings(model.config.vocab_size+1)    # adjust VST token
        ...
        print(f"[builder.py] [load_pretrained_model] image_processor : {image_processor}")
