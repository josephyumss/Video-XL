...
from videoxl.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_INDEX
from videoxl.train.llava_trainer import LLaVATrainer
from videoxl.train.pretrain_llava_trainer import Pre_LLaVATrainer
        ...
        if "mixtral" in model_args.model_name_or_path.lower():
            ...
            if "moe" in model_args.model_name_or_path.lower() or "A14B" in model_args.model_name_or_path:
                ...
                if  training_args.pretrain:
                    model = Naive_LlavaQwenForCausalLM.from_pretrained(
                        model_args.model_name_or_path,
                        cache_dir=training_args.cache_dir,
                        attn_implementation=training_args.attn_implementation,
                        torch_dtype=(torch.bfloat16 if training_args.bf16 else None),
